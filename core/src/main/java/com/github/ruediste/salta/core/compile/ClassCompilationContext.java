...
public class ClassCompilationContext {
	...
	/**
	 * Add a new Method to this class. The name will be generated by this context
	 * and is guaranteed not to conflict with any existing method.
	 *
	 ...
	 *                   {@code null}.
	 * @param recipe     recipe to be used to compile the method
	...
	/**
	 * Returns the class loader which is used to load the compiled code. Required
	 * during compilation to check if the classes used by the compiled code will be
	 * the correct ones.
	 */
