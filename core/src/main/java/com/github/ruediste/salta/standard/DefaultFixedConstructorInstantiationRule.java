 ...
 */
public class DefaultFixedConstructorInstantiationRule implements FixedConstructorInstantiationRule {

    private StandardInjectorConfiguration config;

    public DefaultFixedConstructorInstantiationRule(StandardInjectorConfiguration config) {
        this.config = config;
    }
    ...
    public Optional<RecipeInstantiator> create(TypeToken<?> typeToken, RecipeCreationContext ctx,
        ...
        ArrayList<SupplierRecipe> args = resolveArguments(config, typeToken, ctx, constructor);
        return Optional.of(createRecipeInstantiator(typeToken, constructor, args));
    ...
    protected FixedConstructorRecipeInstantiator createRecipeInstantiator(TypeToken<?> typeToken,
            Constructor<?> constructor, ArrayList<SupplierRecipe> args) {
