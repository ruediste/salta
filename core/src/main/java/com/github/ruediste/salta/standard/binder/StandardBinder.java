...
public class StandardBinder {
	...
	/**
	 * Upon successful creation, the {@link StandardInjector} will inject instance
	 ...
	 * The returned provider will not be valid until the {@link StandardInjector}
	 * has been created. The provider will throw an {@code IllegalStateException} if
	 ...
	 * injector will not be valid until the main {@link StandardInjector} has been
	 * created. The members injector will throw an {@code IllegalStateException} if
	 * you try to use it beforehand.
	 *
