package com.github.ruediste.salta.standard.test.recipe;
...
public class FixedMethodRecipeMembersInjectorTest {
	...
	private static class Builder {
		...
		public Builder(GeneratorAdapter mv, MethodCompilationContext ctx, String methodName) {
			this.mv = mv;
			this.ctx = ctx;
		...
		void m() throws NoSuchMethodException, SecurityException {
			new FixedMethodRecipeMembersInjector(TestC.class.getDeclaredMethod(methodName), Arrays.asList());
		}

		void m(Class<?> param, SupplierRecipe recipe) throws NoSuchMethodException, SecurityException {
			new FixedMethodRecipeMembersInjector(TestC.class.getDeclaredMethod(methodName, param),
			...
			return new SupplierRecipe() {
				...
				protected Class<?> compileImpl(GeneratorAdapter mv, MethodCompilationContext ctx) {
					...
					mv.visitMethodInsn(INVOKESTATIC,
							"com/github/ruediste/salta/standard/test/recipe/FixedMethodRecipeMembersInjectorTest$Helper",
			...
			return new SupplierRecipe() {
				...
				protected Class<?> compileImpl(GeneratorAdapter mv, MethodCompilationContext ctx) {
					mv.visitMethodInsn(INVOKESTATIC,
							"com/github/ruediste/salta/standard/test/recipe/FixedMethodRecipeMembersInjectorTest$Helper",
							"getPub",
							"()Lcom/github/ruediste/salta/standard/test/recipe/FixedMethodRecipeMembersInjectorTest$TestPub;",
							false);
	...
	private void doTestDetail(String methodName) throws Throwable {
		SupplierRecipe recipe = new SupplierRecipe() {

			@Override
			protected Class<?> compileImpl(GeneratorAdapter mv, MethodCompilationContext ctx) {

				Builder b = new Builder(mv, ctx, methodName);
