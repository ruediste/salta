/**
 * Copyright (C) 2015 Ruedi Steinmann
 * 
 ...
 * which will be used to create an {@link Injector}. A Guice-based application
 * is ultimately composed of little more than a set of {@code Module}s and some
 * bootstrapping code.
 *
 * <p>
 ...
 *
 * <p>
 * In addition to the bindings configured via {@link #configure}, bindings will
