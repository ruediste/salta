...
public class ScopedBindingBuilderImpl<T> implements ScopedBindingBuilder<T> {
	...
	private com.github.ruediste.salta.standard.binder.ScopedBindingBuilder<T> delegate;

	public ScopedBindingBuilderImpl(
			com.github.ruediste.salta.standard.binder.ScopedBindingBuilder<T> delegate) {
