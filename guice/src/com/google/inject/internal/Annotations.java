...
public class Annotations {
    ...
    public static boolean isAllDefaultMethods(
    ...
    private static final LoadingCache<Class<? extends Annotation>, Annotation> cache = CacheBuilder
            .newBuilder().weakKeys()
     ...
     * annotation is all optionals.
     */
    public static <T extends Annotation> T generateAnnotation(
    ...
    private static <T extends Annotation> T generateAnnotationImpl(
                ...
                new Class<?>[] { annotationType }, new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method,
                        ...
                        if (name.equals("annotationType")) {
                            ...
                            return annotationEquals(annotationType, members,
                                    args[0]);
                        } else {
    ...
    /**
     * Checks for the presence of annotations. Caches results because Android
     * doesn't.
     */
    static class AnnotationChecker {
        ...
        final LoadingCache<Class<? extends Annotation>, Boolean> cache = CacheBuilder
                .newBuilder().weakKeys().build(hasAnnotations);
    ...
    public static boolean isScopeAnnotation(
            Class<? extends Annotation> annotationType) {
        return scopeChecker.hasAnnotations(annotationType);
    }

    /**
     * Adds an error if there is a misplaced annotations on {@code type}.
    ...
    public static Key<?> getKey(TypeLiteral<?> type, Member member,
            ...
            if (isBindingAnnotation(annotationType)) {
                if (found != null) {
                    errors.duplicateBindingAnnotations(member,
                            found.annotationType(), annotationType);
                } else {
                    found = annotation;
                }
            }
    ...
    /**
     * Returns true if annotations of the specified type are binding
     * annotations.
     */
    public static boolean isBindingAnnotation(
            Class<? extends Annotation> annotationType) {
        return bindingAnnotationChecker.hasAnnotations(annotationType);
    }

    /**
     * If the annotation is an instance of {@code javax.inject.Named},
     * canonicalizes to com.google.guice.name.Named. Returns the given
    ...
    /**
     * If the annotation is the class {@code javax.inject.Named}, canonicalizes
     * to com.google.guice.name.Named. Returns the given annotation class
     * otherwise.
     */
