 ...
 * is the core of Guice, although you rarely interact with it directly. This
 * "behind-the-scenes" operation is what distinguishes dependency injection from
 * its cousin, the service locator pattern.
 *
 * <p>
...
public interface Injector {
    ...
    com.github.ruediste.salta.standard.StandardInjector getSaltaInjector();
}
