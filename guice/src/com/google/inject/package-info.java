 ...
 * <a href="http://docs.google.com/Doc?id=dd2fhx4z_5df5hw8">User's Guide</a> for
 ...
 * where and how it should send in ("inject") the objects you depend on (your
 * "dependencies").
 *
 * <dt>{@link com.google.inject.Module}
 * <dd>The interface you will implement in order to specify "bindings" --
 * instructions for how Guice should handle injection -- for a particular set of
 * interfaces.
 *
