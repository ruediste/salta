...
/**
 * An object capable of providing instances of type {@code T}. Providers are
 * used in numerous ways by Guice:
 *
 * <ul>
 ...
 * give you access to multiple instances, instances you wish to safely mutate
 * and discard, instances which are out of scope (e.g. using a
