...
public class GenericInjectionTest extends TestCase {
    ...
    public void testImplicitBindingOfGenericType() {
        Parameterized<String> parameterized = Guice.createInjector()
    ...
    public void testInjectingParameterizedDependenciesForImplicitBinding() {
        assertParameterizedDepsInjected(
                new Key<ParameterizedDeps<String, Integer>>() {
                }, Modules.EMPTY_MODULE);
    }

    public void testInjectingParameterizedDependenciesForBindingTarget() {
        final TypeLiteral<ParameterizedDeps<String, Integer>> type = new TypeLiteral<ParameterizedDeps<String, Integer>>() {
        };

        assertParameterizedDepsInjected(Key.get(Object.class),
                new AbstractModule() {
                    protected void configure() {
    ...
    public void testBindingSubtype() {
        final TypeLiteral<SubParameterizedDeps<String, Long, Integer>> type = new TypeLiteral<SubParameterizedDeps<String, Long, Integer>>() {
        };
    ...
    public void testImmediateTypeVariablesAreInjected() {
        ...
        InjectsT<String> injectsT = injector
                .getInstance(new Key<InjectsT<String>>() {
                });
