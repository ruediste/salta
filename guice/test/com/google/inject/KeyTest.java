...
public class KeyTest extends TestCase {
    ...
    public void testKeyEquality() {
        ...
        Key<List<String>> b = Key.get(new TypeLiteral<List<String>>() {
        }, Foo.class);
    ...
    public void testTypeEquality() throws Exception {
        ...
        assertFalse(types[0].equals(new Key<List<Integer>>() {
        }.getTypeLiteral().getType()));
    }

    /**
     * Key canonicalizes {@link int.class} to {@code Integer.class}, and won't
     * expose wrapper types.
     */
    ...
    /** Test for issue 186 */
    public void testCannotCreateKeysWithTypeVariables()
            throws NoSuchMethodException {
        ParameterizedType listOfTType = (ParameterizedType) getClass()
        ...
        TypeVariable tType = (TypeVariable) listOfTType
    ...
    public void testKeysWithDefaultAnnotations() {
        AllDefaults allDefaults = HasAnnotations.class
                .getAnnotation(AllDefaults.class);
        assertEquals(Key.get(Foo.class, allDefaults),
                Key.get(Foo.class, AllDefaults.class));

        Marker marker = HasAnnotations.class.getAnnotation(Marker.class);
        assertEquals(Key.get(Foo.class, marker),
                Key.get(Foo.class, Marker.class));
