...
public class ModuleAnnotatedMethodScannerTest extends TestCase {
	...
	public void testScanning() throws Exception {
		...
		Binding<String> fooBinding = injector.getBinding(Key.get(String.class, named("foo")));
		Binding<String> foo2Binding = injector.getBinding(Key.get(String.class, named("foo2")));
		...
		assertEquals("Provider<Key[type=java.lang.String, annotation=@com.google.inject.name.Named(value=\"foo\")]>",
				fooBinding.getProvider().toString());
		assertEquals("Provider<Key[type=java.lang.String, annotation=@com.google.inject.name.Named(value=\"foo2\")]>",
